...
public class GrasinWorkbenchScreenHandler extends ScreenHandler {
	...
	public GrasinWorkbenchScreenHandler(int syncId, PlayerInventory playerInventory,
		...
		super(ModScreenHandlers.GRASIN_WORKBENCH_SCREEN_HANDLER, syncId);
		this.inventory = ((Inventory) blockEntity);
		this.blockEntity = ((GrasinWorkbenchBlockEntity) blockEntity);
		this.propertyDelegate = arrayPropertyDelegate;
		
		this.addSlot(new Slot(inventory, 0, 54, 24));
		this.addSlot(new Slot(inventory, 1, 54, 46));
		this.addSlot(new Slot(inventory, 2, 104, 20));
		this.addSlot(new Slot(inventory, 3, 104, 49));
